            ...
            user.getIdToken(true).then(function (idToken) {
                ...
                req.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        req.onreadystatechange = function () {
                            if (this.readyState == 4 && this.status == 200) {
                                ...
                                if (response_code == 1) {
                                    ...
                                    const ENDPOINT = API_ENDPOINT + "/bookings/pay";
                        ...
                        const ENDPOINT = API_ENDPOINT + "/orders/write";
                        req.open("POST", ENDPOINT, true);
                        req.setRequestHeader("Content-type", "application/json");
                        let json = {
                            "full_name": full_name,
                ...
                const ENDPOINT = API_ENDPOINT + "/bookings/order_number?token=" + idToken + "&booking_id=" + booking_id;
